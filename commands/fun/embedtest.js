const { SlashCommandBuilder, EmbedBuilder } = require('discord.js'); // discord.js must be found to use this const

module.exports = { //no fuckin clue brah

    data: new SlashCommandBuilder() //creating a new instance of a slash command
		.setName('embedtest') //the name of the command (NOT THE EMBED TITLE)
		.setDescription('testing an embed for my bot'), //the description of the command (NOT THE EMBED DESC.)
    async execute(interaction){ //what the command be doing
